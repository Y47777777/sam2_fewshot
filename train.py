...
data_dir=r"/home/visionnav/code/sam2/dataset/wrappallet/train/" # Path to dataset (LabPics 1)
data=[] # list of files in dataset
for ff, name in enumerate(os.listdir(data_dir + "images")):  # go over all folder annotation
    data.append({"image":data_dir + "images/" + name, "annotation":data_dir + "masks/" + name[:-4] + ".png"})
...
sam2_checkpoint = "checkpoints/sam2_hiera_large.pt" # path to model weight (pre model loaded from: https://dl.fbaipublicfiles.com/segment_anything_2/072824/sam2_hiera_small.pt)
model_cfg = "configs/sam2/sam2_hiera_l.yaml" #  model config
