...
def Parser():
    ...
    parser.add_argument('--few_shot_path', type=str, default='/home/visionnav/code/sam2/dataset/ford-brighteye/fewshot', help='模板图和mask')
    parser.add_argument('--test_path', type=str, default='/home/visionnav/code/sam2/dataset/ford-brighteye/test', help='待打标的图像')
    parser.add_argument('--save_root', type=str, default='/home/visionnav/code/sam2/save_path/ford-brighteye', help='保存路径')
...
def main(args):
    ...
    res_dic = predict(few_shot_path, test_path, save_root, few_shot_num, labels_name_dic, input_bboxs=mask_list)
    if res_dic != None:
        print('---all---')
        all_recall_500595 = []
